# -*- coding: utf-8 -*-
"""
Created on Mon Jun 22 08:43:13 2020
...
def calculate(Evaluator,db):
    total_points=0
    team_name=Evaluator.teams_combobox.currentText()
    ...
    for player in players:
        ...
        Evaluator.points_list.addItem(player[0]+(' '*10)+str(points))
        total_points+=points
        Evaluator.points_scored.setText(str(total_points))
